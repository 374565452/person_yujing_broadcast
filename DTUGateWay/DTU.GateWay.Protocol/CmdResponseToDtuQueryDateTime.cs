...
{
    public class CmdResponseToDtuQueryDateTime : BaseMessage
    {
        public CmdResponseToDtuQueryDateTime()
        {
        ...
        public CmdResponseToDtuQueryDateTime(BaseMessage bm)
        {
            BeginChar = BaseProtocol.BeginChar;
            EndChar = BaseProtocol.EndChar;
        ...
        public override string ReadMsg()
        {
            ...
            {
                logHelper.Error(ex.Message + Environment.NewLine + RawDataStr);
                return "获取设置时间出错";
            }
