...
{
    public class WaterCmd_48_1 : WaterBaseMessage
    {
        public WaterCmd_48_1()
        {
        ...
        public string ReadMsg()
        {
            ...
            if (msg == "")
            {
                ...
                {
                    if (List_RTUParam[0].GetKey() == (byte)RTUParam.RTUParamKey._98)
                    {
                        rp = (RTUParam_98)List_RTUParam[0];
                    }
                    else
                    {
                        msg = "数据体非法，参数关键字非法";
