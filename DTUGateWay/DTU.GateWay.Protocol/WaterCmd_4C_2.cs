...
{
    public class WaterCmd_4C_2 : WaterBaseMessage
    {
        public WaterCmd_4C_2()
        {
            AFN = (byte)WaterBaseProtocol.AFN._4C;
        ...
        public string ReadMsg(string UserDataAll)
        {
            ...
            {
                if (ShowLog) logHelper.Error(ex.Message + Environment.NewLine + "获取泵开关状态出错" + " " + RawDataStr);
                return "获取泵开关状态出错";
            }
