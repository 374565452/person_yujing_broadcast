...
{
    public class Identifier_1A : Identifier
    {
        /// <summary>
        /// 标识符引导符
        /// </summary>
        public byte Key = 0x1A;
        ...
        public override string ToString()
        {
            ...
            builder.Append(Precipitation.HasValue ? Precipitation + "毫米，" : "-，");
        ...
        public override string GetHexStr()
        {
            ...
            try
            {
                ...
                if ((double)Precipitation.Value * Math.Pow(10, Digits) >= Math.Pow(10, ByteCount * 2))
                {
                    return "";
                }

                StringBuilder builderC = new StringBuilder();
                builderC.Append(((double)Precipitation.Value * Math.Pow(10, Digits)).ToString().PadLeft(ByteCount * 2, '0'));
        ...
        public override void SetVal(int ByteCount, int Digits, string hexStr)
        {
            ...
            try
            {
                this.Precipitation = (decimal)(Convert.ToInt32(hexStr) * 1.0 / Math.Pow(10, Digits));
            }
            catch
            {
