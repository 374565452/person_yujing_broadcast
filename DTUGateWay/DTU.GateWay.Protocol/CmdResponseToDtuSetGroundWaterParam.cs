...
{
    public class CmdResponseToDtuSetGroundWaterParam : BaseMessage
    {
        public CmdResponseToDtuSetGroundWaterParam()
        {
            BeginChar = BaseProtocol.BeginChar;
            EndChar = BaseProtocol.EndChar;

            //AFN = 0x57;
            AFN = (byte)BaseProtocol.AFN.ToDtuSetGroundWaterParam;
            //ControlField = 0xB3;
            ControlField = (byte)BaseProtocol.ControlField.FromDtu;
        }

        public CmdResponseToDtuSetGroundWaterParam(BaseMessage bm)
        {
            BeginChar = BaseProtocol.BeginChar;
            EndChar = BaseProtocol.EndChar;
