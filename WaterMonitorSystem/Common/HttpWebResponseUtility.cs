...
namespace Common
{
    public class HttpWebResponseUtility
    {
        ...
        public static string getPostResponse(string loginUrl, string Method, IDictionary<string, string> parameters, string defaultStr, string errorStr)
        {
            string retString = defaultStr;
