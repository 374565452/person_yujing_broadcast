...
namespace Common
{
    public class ChinesePY
    {
        ...
        {
            byte[] bytes = Encoding.Default.GetBytes(hz);
            ...
            for (int i = 0; i < bytes.Length; i++)
            {
                ...
                if (num > 160)
                {
                    num = ((num * 0x100) + bytes[++i]) - 0x10000;
                    builder.Append(g(num));
                }
                else
                {
        ...
        public static string GetPinYinIndex(string str)
        {
            ...
            {
                double num2 = (double)str[i];
                if ((num2 >= 19968.0) && (num2 < 40869.0))
                {
                    builder.Append(Convert(str[i]));
                }
            }
            return builder.ToString();
        }
